    ...
    <body> 
        ...
        <section class="container-fluid  h-100  text-white">
            ...
            <nav class="row navbar navbar-expand-lg navbar-light bg-light">
                ...
                <a class="btn btn-primary" href="${pageContext.request.contextPath}/student/mycourses"> My courses</a>
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                    ...
                    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="${pageContext.request.contextPath}/student">Store<span class="sr-only">(current)</span></a>
                        </li>
                        <!-- <li class="nav-item">
